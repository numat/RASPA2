...
#define NR_BEND_TYPES 10
enum {HARMONIC_BEND,CORE_SHELL_BEND,QUARTIC_BEND,CFF_QUARTIC_BEND,HARMONIC_COSINE_BEND,COSINE_BEND,MM3_BEND,MM3_IN_PLANE_BEND,FIXED_BEND,MEASURE_BEND};
...
#define NR_BOND_BOND_TYPES 2
enum {CVFF_BOND_BOND_CROSS,CFF_BOND_BOND_CROSS};
