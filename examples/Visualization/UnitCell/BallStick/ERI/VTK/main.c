...
int main( int argc, char *argv[] )
{
  ...
  vtkPlane *p2=vtkPlane::New();
     p2->SetOrigin(CellBox.ax*SIZE_X/max,CellBox.ay*SIZE_Y/max,CellBox.az*SIZE_Z/max);
  ...
  vtkPlane *p4=vtkPlane::New();
     p4->SetOrigin(CellBox.bx*SIZE_X/max,CellBox.by*SIZE_Y/max,CellBox.bz*SIZE_Z/max);
  ...
  vtkPlane *p6=vtkPlane::New();
     p6->SetOrigin(CellBox.cx*SIZE_X/max,CellBox.cy*SIZE_Y/max,CellBox.cz*SIZE_Z/max);
  ...
  if(FileExists(FrameworkAtomsFilename)&&(FrameworkAtoms==ON))
  {
    ...
    vtkGlyph3D *GlyphFramework=vtkGlyph3D::New();
      GlyphFramework->SetInput(ReaderFrameworkAtoms->GetOutput());
      GlyphFramework->SetSource(Atom->GetOutput());
  ...
  if(FileExists(AdsorbateAtomsFilename)&&(Adsorbates==ON))
  {
    ...
    vtkGlyph3D *GlyphAdsorbate=vtkGlyph3D::New();
      GlyphAdsorbate->SetInput(AtomReaderAdsorbate->GetOutput());
      GlyphAdsorbate->SetSource(Atom->GetOutput());
    ...
    vtkClipClosedSurface *ClipSurfaceAdsorbateAtoms=vtkClipClosedSurface::New();
       ...
       ClipSurfaceAdsorbateAtoms->SetInput(GlyphAdsorbate->GetOutput());
    ...
    vtkTubeFilter *BondsTubeAdsorbate=vtkTubeFilter::New();
      BondsTubeAdsorbate->SetInput(AtomReaderAdsorbate->GetOutput());
    ...
    vtkClipClosedSurface *ClipSurfaceAdsorbates=vtkClipClosedSurface::New();
       ...
       ClipSurfaceAdsorbates->SetInput(BondsTubeAdsorbate->GetOutput());
  ...
  if(FileExists(CationAtomsFilename)&&(Cations==ON))
  {
    ...
    vtkGlyph3D *GlyphCations=vtkGlyph3D::New();
      GlyphCations->SetInput(AtomReaderCations->GetOutput());
      GlyphCations->SetSource(Atom->GetOutput());
    ...
    vtkClipClosedSurface *ClipSurfaceCationAtoms=vtkClipClosedSurface::New();
       ...
       ClipSurfaceCationAtoms->SetInput(GlyphCations->GetOutput());
    ...
    vtkTubeFilter *BondsTubeCations=vtkTubeFilter::New();
      BondsTubeCations->SetInput(AtomReaderCations->GetOutput());
    ...
    vtkClipClosedSurface *ClipSurfaceCations=vtkClipClosedSurface::New();
       ...
       ClipSurfaceCations->SetInput(BondsTubeCations->GetOutput());
    ...
    switch(FrameworkRenderingMethod)
    {
      ...
      case VOLUME_RENDERING:
        ...
        vtkVolumeRayCastMapper *FrameworkSurfaceMapper = vtkVolumeRayCastMapper::New();
          FrameworkSurfaceMapper->SetInput(FrameworkSurfaceReader->GetOutput());
  ...
  if(FileExists(DensityFilename)&&(Density==ON))
  {
    ...
    vtkVolumeProperty *DensityProperty = vtkVolumeProperty::New();
      ...
      DensityProperty->SetScalarOpacity(oTFunDensity);
    ...
    vtkVolumeRayCastMapper *DensityMapper = vtkVolumeRayCastMapper::New();
      DensityMapper->SetInput(DensityReader->GetOutput());
